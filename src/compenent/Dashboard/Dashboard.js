        ...
        return (
            <>
                <div className="d-flex justify-content-center">
                    ...
                    <div className="shadow bg-body rounded col-sm-5" style={{ height: '96vh' }}>
                ...
                {this.state.expensePop && <Expense onBackDrop={this.expenseHandler} onNewExpense={this.newExpensehandler} />}
            </>
        )
    }
}
